...
class _WeatherWidgetState extends State<WeatherWidget> {
  ...
  _fetchData() async {
    ...
    // get where city name you are living by lat and lon from google maps api
    var currentLocation = await getLocation(lat, lon);
    // get weather temp(int var) by lat and lon from openweathermap api
    var currentTemperature =
        await openWeatherAPI.getCurrentTemperature(lat, lon);
    // return a list (DailyForecast class) of weather forecast by lat and lon
    var weatherForecast =
